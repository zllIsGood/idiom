...
class RoleItem extends eui.ItemRenderer {
    ...
    protected dataChanged() {
        ...
        if (data.normalImg) {
            this.roleF.source = isUpLevel ? data.normalImg2 : data.normalImg
            // this.roleF.source = isUpLevel ? data.happyImg2 : data.happyImg
            // this.roleF.source = isUpLevel ? data.cryImg2 : data.cryImg
        }
        if (data.hairImg) {
            if (!this.roleHair) {
