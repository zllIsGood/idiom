...
class Main extends eui.UILayer {
	...
	// 平台相关配置
	public static version: string = "10200";
	...
	/**bgm*/
	public static bgm = 'https://cdnzmg.zmfamily.cn/idiom/bgm.mp3'
	public static res_url = 'https://cdnzmg.zmfamily.cn/idiom/res_url_cfg.json'  //'./res/res_url_cfg.json' //
